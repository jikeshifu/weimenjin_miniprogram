...
CodeInfoDlg.collectData = function () {
	this.set('locklog_id').set('locklog_id').set('member_id').set('user_id').set('lock_id').set('lock_name').set('headimgurl').set('nickname').set('realname').set('remark').set('mobile').set('create_time');
};
