...
CodeInfoDlg.collectData = function () {
	this.set('locktimes_id').set('locktimes_id').set('locktimesname').set('user_id').set('lock_id').set('startweek').set('starthour').set('startminute').set('endweek').set('endhour').set('endminute').set('create_time');
};
