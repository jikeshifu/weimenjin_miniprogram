...
CodeInfoDlg.collectData = function () {
	this.set('member_id').set('member_id').set('nickname').set('headimgurl').set('openid').set('ali_user_id').set('mobile').set('username').set('password').set('create_time').set('user_id');
};
