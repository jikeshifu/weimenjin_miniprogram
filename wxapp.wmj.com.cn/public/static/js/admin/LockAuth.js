...
CodeInfoDlg.collectData = function () {
	this.set('lockauth_id').set('lockauth_id').set('lock_id').set('lock_name').set('member_id').set('headimgurl').set('nickname').set('realname').set('remark').set('mobile').set('auth_member_id').set('auth_sharelimit').set('auth_starttime').set('auth_endtime').set('create_time').set('auth_openlimit').set('auth_openused').set('auth_opentimes').set('user_id');
};
