...
return [
	...
	'ali_oss_endpoint'			=> 'http://img.weimenjin.com',	//建议填写自己绑定的域名
	...
	'qny_oss_bucket'	  	=> 'weimenjin',							//bucket
	'qny_oss_domain'	  	=> 'http://img.weimenjin.com/', 		// 七牛云绑定图片访问域名 后缀加斜杠
	
	//jwt鉴权配置
	'jwt_expire_time'		=> 2592000,				//token过期时间 默认2小时
	'jwt_secrect'			=> 'boTCfOGKwqTNKArT',	//签名秘钥
	'jwt_iss'				=> 'client.weimenjin',	//发送端
	'jwt_aud'				=> 'server.weimenjin',	//接收端
	
	//小程序配置
	'mini_program'			=> [
		'app_id' => 'wx7fdcb0b7df1b5439',					//小程序appid
		'secret' => 'cb1fd817fd7f6d0bee1731e181ee27b1',		//小程序secret
	],
	...
	'email'	=> [
		...
		'Port'		=> 465,					//邮箱端口
		'From'		=> '13886161@qq.com',	//发送者邮箱
		'FromName'	=> 'weimenjin',			//发送者昵称
		'Username'	=> '13886161@qq.com',	//登录邮箱用户名
