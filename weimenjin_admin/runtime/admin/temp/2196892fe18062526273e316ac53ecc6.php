<?php /*a:2:{s:59:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/index/main.html";i:1731647734;s:66:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/common/_container.html";i:1731647734;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
		...
		<div class="col-sm-12">
			<div class="alert alert-success alert-dismissable">
				<button aria-hidden="true" data-dismiss="alert" class="close"
					type="button">×</button>
				<?php echo session('admin.username'); ?>，欢迎使用<?php echo config('xhadmin.site_title'); ?>
			</div>
		</div>
	</div>
