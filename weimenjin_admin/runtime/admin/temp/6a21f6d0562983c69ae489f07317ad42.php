<?php /*a:2:{s:64:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/lock_auth/index.html";i:1731647734;s:66:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/common/_container.html";i:1731647734;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="ibox-content">
				<div class="row row-lg">
					<div class="col-sm-12">
						...
						<?php if(in_array('/admin/LockAuth/update',session('admin.nodes')) || session('admin.role') == 1): ?>
						<button type="button" id="update" class="btn btn-success button-margin" onclick="CodeGoods.update()">
						<i class="fa fa-pencil"></i>&nbsp;修改
						</button>
						<?php endif; if(in_array('/admin/LockAuth/delete',session('admin.nodes')) || session('admin.role') == 1): ?>
						<button type="button" id="delete" class="btn btn-danger button-margin" onclick="CodeGoods.delete()">
						<i class="fa fa-trash"></i>&nbsp;删除
						</button>
						<?php endif; if(in_array('/admin/LockAuth/view',session('admin.nodes')) || session('admin.role') == 1): ?>
...
<script>
	...
	CodeGoods.update = function (value) {
		if(value){
			var index = layer.open({type: 2,title: '修改',area: ['600px', '450px'],fix: false, maxmin: true,content: Feng.ctxPath + '/LockAuth/update?lockauth_id='+value});
			if(!IsPC()){layer.full(index)}
		}else{
			if (this.check()) {
				var idx = '';
				...
				var index = layer.open({type: 2,title: '修改',area: ['600px', '450px'],fix: false, maxmin: true,content: Feng.ctxPath + '/LockAuth/update?lockauth_id='+idx});
				this.layerIndex = index;
				if(!IsPC()){layer.full(index)}
			}
		}
