<?php /*a:2:{s:63:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/wservice/index.html";i:1731647734;s:66:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/common/_container.html";i:1731647734;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="ibox-content">
				<div class="row row-lg">
					<div class="col-sm-12">
						...
						<?php if(in_array('/admin/Wservice/add',session('admin.nodes')) || session('admin.role') == 1): ?>
						<button type="button" id="add" class="btn btn-primary button-margin" onclick="CodeGoods.add()">
						<i class="fa fa-plus"></i>&nbsp;添加
						</button>
						<?php endif; if(in_array('/admin/Wservice/update',session('admin.nodes')) || session('admin.role') == 1): ?>
						<button type="button" id="update" class="btn btn-success button-margin" onclick="CodeGoods.update()">
						<i class="fa fa-pencil"></i>&nbsp;修改
						</button>
						<?php endif; if(in_array('/admin/Wservice/delete',session('admin.nodes')) || session('admin.role') == 1): ?>
						<button type="button" id="delete" class="btn btn-danger button-margin" onclick="CodeGoods.delete()">
						<i class="fa fa-trash"></i>&nbsp;删除
						</button>
						<?php endif; if(in_array('/admin/Wservice/view',session('admin.nodes')) || session('admin.role') == 1): ?>
...
<script>
	...
	CodeGoods.buttonFormatter = function(value,row,index) {
		if(row.wservice_id){
			var str= '';
			<?php if(in_array('/admin/Wservice/update',session('admin.nodes')) || session('admin.role') == 1): ?>
