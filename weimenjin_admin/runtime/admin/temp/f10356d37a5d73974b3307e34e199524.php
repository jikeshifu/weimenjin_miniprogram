<?php /*a:1:{s:60:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/login/index.html";i:1731647734;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/static/login_new/static/css/e26f8e48f3f747dfa9fb3972355ed854.css">
...
<body class="off-canvas-sidebar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                 ...
                 <li class="">
                        <a href="javascript:void(0)" onclick="openImg('https://<?php echo $_SERVER['HTTP_HOST']; ?>/qrdata/qrcode/adduser.png')">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="__PUBLIC__/static/login_new/static/picture/login.jpeg">
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                                ...
                                <div class="card card-login card-hidden">
                                    <div class="card-header text-center" data-background-color="rose">
                                        ...
                                        <h8 class="card-title">登陆</h8>
                                        <div class="social-line">

                                        </div>
                                    </div>
                                    <p class="category text-center">
                                        <a href="/admin/Login/indexQrCode">微信扫码登录</a>
                                    </p>
                                    <div class="card-content" style="margin-top:30px">
                                        ...
                                        <div class="input-group" style="margin-top:15px">
                                         ...
                                         <div class="input-group" style="margin-top:15px">
                                            ...
                                            <div class="form-group label-floating">
                                                ...
                                                <input name="verify" id="averfiy" type="text" autocomplete="off" class="form-control password">
                                            </div>
                                        </div>
                                        <div class="input-group" style="margin-top:5px">
                                            ...
                                            <div class="form-group label-floating">
                                                 <img src="<?php echo url('admin/Login/Verify'); ?>" onClick="this.src=this.src+'?'+Math.random()" alt="点击刷新验证码" id="img"  style="cursor:pointer;width:66%; height:50px;margin-top:">
                                            </div>
                                        </div>
									</div>
                                    ...
                                    <div class="footer text-center">
                                        ...
                                        <input name="提交" id="submit" type="button" onClick="login()" class="btn btn-primary btn-round" value="登录" >
...
<!--<div class="fixed-plugin">
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="header-title">选择背景</li>
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="__PUBLIC__/static/login_new/static/picture/sidebar-1.jpg" data-src="__PUBLIC__/static/login_new/static/picture/login.jpeg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="__PUBLIC__/static/login_new/static/picture/sidebar-2.jpg" data-src="__PUBLIC__/static/login_new/static/picture/lock.jpeg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="__PUBLIC__/static/login_new/static/picture/sidebar-3.jpg" data-src="__PUBLIC__/static/login_new/static/picture/register.jpeg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="__PUBLIC__/static/login_new/static/picture/sidebar-4.jpg" data-src="__PUBLIC__/static/login_new/static/picture/bg-pricing.jpeg" alt="" />
                </a>
            </li>
            <li class="button-container">
            		<div class="">
                        <a href="http://wpa.qq.com/msgrd?v=3&uin=13886161&site=qq&menu=yes" target="_blank" class="btn btn-rose btn-block">联系我们</a>
                    </div>
                                        <div class="">
                        <a href="javascript:volid(0);" target="_blank" class="btn btn-info btn-block">邮箱：service@kuaige.com</a>
                    </div>
            </li>
