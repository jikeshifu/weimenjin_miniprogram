<?php /*a:2:{s:61:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/member/index.html";i:1731647734;s:66:"/www/wwwroot/demo.wmj.com.cn/app/admin/view/common/_container.html";i:1731647734;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--							</div>-->
						...
						<?php endif; if(in_array('/admin/Member/resetpassword',session('admin.nodes')) || session('admin.role') == 1): ?>
...
<script>
	...
	CodeGoods.buttonFormatter = function(value,row,index) {
		if(row.member_id){
			var str= '';
			<?php if(in_array('/admin/Member/update',session('admin.nodes')) || session('admin.role') == 1): ?>
