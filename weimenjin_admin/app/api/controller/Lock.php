    ...
    private function createmarkqrcode($url, $qrcodename)
    {
        ...
        if (!is_file($qrcode_file)) {
            ...
            try {
                ...
                // 保存二维码到文件
                if (file_put_contents($qrcode_file, $qrcodeData) === false) {
                    mlog("二维码保存失败: " . $qrcode_file);
                    return false;
                }
            } catch (\Exception $e) {
