...
CodeInfoDlg.collectData = function () {
	this.set('lock_id').set('lock_id').set('member_id').set('user_id').set('lock_name').set('lock_sn').set('lock_sn').set('lock_type').set('location').set('lock_qrcode').set('create_time').set('successimg').set('successadimg').set('openadurl');
};
