...
export function wechatoauth_api(params) {
  return request('/member.Member/login', params, 'POST');
}

// 支付宝小程序授权API
export function alipayoauth_api(params) {
  return request('/member/alipaylogin', params, 'POST');
}

// 抖音小程序授权API
export function toutiaoauth_api(params) {
  return request('/Member/toutiaoauth', params, 'POST');
}

// 发送短信验证码
export function sendSms_api(params) {
  return request('/member.Member/sendSms', params, 'POST');
}

// 验证码登录
export function smsLogin_api(params) {
  return request('/member.Member/smsLogin', params, 'POST');
}
