...
import { getToken, setToken} from '@/libs/auth.js'
// import { upimg_api } from '@/api/index.js'
import { imgPath } from '@/libs/filters.js';
import { commonUrl } from '@/api/request.js'
						...
						await uni.uploadFile({
							...
							success: uploadFileRes => {
								...
								this.editorCtx.insertImage({
									src: imgPath(res.data),  // 此处需要将图片地址切换成服务器返回的真实图片地址
									alt: '图片',
									success: function(e) {}
								});
								uni.hideLoading()
