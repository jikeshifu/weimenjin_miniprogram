...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			internal.attr(span, "class", span_class_value = "" + (internal.null_to_empty(/*c*/ ctx[1]) + " svelte-snamjk"));
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*c*/ 2 && span_class_value !== (span_class_value = "" + (internal.null_to_empty(/*c*/ ctx[1]) + " svelte-snamjk"))) {
...
class Fa_layers extends internal.SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-snamjk-style")) add_css();
